...
Do not remove a device while it may still be allowed or pending. Stop its claims, run **Restore Network State**, verify that its ACL is blocked, and then remove it.
