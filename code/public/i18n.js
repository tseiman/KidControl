const messages = {
  en: {
    ...
    'admin.restore': 'Restore network state',
    'usage.title': 'Usage · last 7 days',
    'usage.barLabel': '{day}: {time} usage',
  ...
  de: {
    ...
    'admin.restore': 'Netzwerkzustand wiederherstellen',
    'usage.title': 'Nutzung · letzte 7 Tage',
    'usage.barLabel': '{day}: {time} Nutzung',
